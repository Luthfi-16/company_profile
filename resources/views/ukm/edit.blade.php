    ...
    <div class="col-xl-12 grid-margin stretch-card flex-column">
        <div class="card">
            <div class="card-body">
                ...
                Untuk Mengedit Data UKM
                </p>
                <form class="form-sample" role="form" action="{{ route('ukm.update', $ukm->id) }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                @csrf
                @method('put')
                <div class="form-group row">
                    <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama UKM</label>
                    <div class="col-sm-9">
                    <input type="text" name="nama_ukm" class="form-control @error('nama_ukm') is-invalid @enderror" id="exampleInputUsername2" placeholder="Nama UKM" value="{{ $ukm->nama_ukm }}">
                    @error('nama_ukm')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control @error('desk') is-invalid @enderror" name="desk" id="" rows="5" placeholder="Deskripsi UKM">{{ $ukm->desk }}</textarea>
                        @error('desk')
                            <div class="invalid-feedback">{{$message}}</div>
                        @enderror
                    </div>
