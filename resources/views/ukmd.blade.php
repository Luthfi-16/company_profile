        ...
        <div class="col-md-12">
          <div class="probootstrap-flex-block d-flex flex-column align-items-center">
            <div class="probootstrap-image probootstrap-animate mb-4" 
                 ...
                 <img src="{{ asset('storage/ukm/' . $ukm->foto) }}" alt="" style="width: 100%; box-shadow: 0px 0px 5px black; background-size: cover; background-position: center;">
            </div>
            <div class="probootstrap-text probootstrap-animate" 
                 style=" box-shadow: 0px 0px 5px black; width: 100%; margin: auto; text-align: justify;">
              <h3><b>Tentang {{ $ukm->nama_ukm }}</b></h3>
              <p>{{ $ukm->desk }}</p>
              <p><a href="{{ url('ukm')}}" class="btn btn-warning">Kembali</a></p>  
            </div>
          </div>
        </div>
      </div>
