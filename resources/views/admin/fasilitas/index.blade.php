    ...
    <div class="col-xl-12 grid-margin stretch-card flex-column">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('fasilitas.create') }}" class="btn" style="color: rgb(255, 255, 255); background-color :gray">Tambah</a>
                </p>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('storage/fasilitas/' . $data->foto) }}" style="border-radius: 0; width: 100px; height: 50px;"/></td>
                            <td><form action="{{ route('fasilitas.destroy', $data->id) }}" method="post">
                                @csrf
                                @method('DELETE')
