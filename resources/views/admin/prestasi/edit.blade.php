    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="nama_prestasi" class="form-control @error('nama_prestasi') is-invalid @enderror" id="exampleInputUsername2" placeholder="Nama prestasi" value="{{ $prestasi->nama_prestasi }}">
                    @error('nama_prestasi')
