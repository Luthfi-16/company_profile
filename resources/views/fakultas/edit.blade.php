  ...
  <div class="col-xl-12 grid-margin stretch-card flex-column">
      ...
      <div class="card-body">
        ...
        <p class="card-description">
          Untuk Mengedit Data Fakultas
        </p>
        <form class="form-sample" role="form" action="{{ route('fakultas.update', $fakultas->id) }}" method="POST" enctype="multipart/form-data" class="forms-sample">
          @csrf
          @method('put')
          <div class="form-group row">
            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama Fakultas</label>
            <div class="col-sm-9">
              <input type="text" name="nama_fakultas" class="form-control @error('nama_fakultas') is-invalid @enderror" id="exampleInputUsername2" placeholder="Nama Fakultas" value="{{ $fakultas->nama_fakultas }}">
              @error('nama_fakultas')
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea class="form-control @error('desk') is-invalid @enderror" name="desk" id="" rows="5" placeholder="Deskripsi Fakultas">{{ $fakultas->desk }}</textarea>
              @error('desk')
                  <div class="invalid-feedback">{{$message}}</div>
              @enderror
            </div>
